(function() {
    BBcode.BUTTONS = [{
        ...
        action: function() {
            ...
            if (isPreviewing) {
                ...
                let html = BBcode.toHTML(this.toolbar.textArea.value);
    ...
    BBcode.toHTML = function(text) {
        let html;
        html = text.replace(/\[(\/?(?:b|i|u|s|center|right))\]/g, "<$1>");
        return html;
    };
    BBcode.wrapValue = function(obj, textarea) {
